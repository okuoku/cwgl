...
CWGL_API void cwgl_texImage2D_buffer(cwgl_ctx* ctx, cwgl_enum target, int32_t level, cwgl_enum internalformat, uint32_t width, uint32_t height, int32_t border, cwgl_enum format, cwgl_enum type, uint32_t offset);
...
CWGL_API void cwgl_compressedTexImage3D_buffer(cwgl_ctx* ctx, cwgl_enum target, int32_t level, cwgl_enum internalformat, uint32_t width, uint32_t height, uint32_t depth, int32_t border, uint32_t imagesize, uint32_t offset);
...
CWGL_API void cwgl_getUniformIndices(cwgl_ctx* ctx, cwgl_Program* program, const char** uniformnames, size_t namecount, uint32_t* out);
CWGL_API cwgl_query_result cwgl_getActiveUniforms_iarray(cwgl_ctx* ctx, cwgl_Program* program, uint32_t* indices, size_t indicecount, cwgl_enum pname, int32_t* out);
CWGL_API uint32_t cwgl_getUniformBlockIndex(cwgl_ctx* ctx, cwgl_Program* program, const char* uniformblockname);
